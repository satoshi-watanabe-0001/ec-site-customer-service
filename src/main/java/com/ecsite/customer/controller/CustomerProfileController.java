...
public class CustomerProfileController {
  ...
  public ResponseEntity<ProfileUpdateResponse> updateProfile(
    ...
    log.info("Received profile update request - customerId: {}, user: {}", id, currentUserId);

    Customer updatedCustomer =
        customerProfileService.updateCustomerProfile(id, request, currentUserId);
    ...
    ProfileUpdateResponse response =
        ProfileUpdateResponse.builder()
            ...
            .data(
                ProfileUpdateResponse.ProfileData.builder()
